...
use TitaKita\Http\Actions\Booking\CreateBookingSessionsAction;
use TitaKita\Http\Actions\Booking\DeleteBookingSessionAction;
use TitaKita\Http\Actions\Booking\GetPublicBookingSessionsAction;
use TitaKita\Http\Actions\Booking\GetScheduleAction;
use TitaKita\Http\Actions\Booking\SaveBookingSettingsAction;
use TitaKita\Http\Actions\Booking\UpdateBookingSessionAction;
...
$router->middleware(['auth:api'])->group(
    function (Router $router): void {
        ...
        // Booking sessions (direct per-session management)
        $router->post('/events/{event_id}/booking-settings', SaveBookingSettingsAction::class);
        $router->post('/events/{event_id}/sessions', CreateBookingSessionsAction::class);
        $router->put('/events/{event_id}/sessions/{product_id}', UpdateBookingSessionAction::class);
        $router->delete('/events/{event_id}/sessions/{product_id}', DeleteBookingSessionAction::class);
